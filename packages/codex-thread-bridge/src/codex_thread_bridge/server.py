...
def make_server(bridge: Bridge):
    ...
    mcp = FastMCP(
        ...
        instructions=(
            ...
            "resume threads. Every mutation states its model and reasoning effort explicitly; "
            "this bridge never inherits the host's configured default and refuses before any "
            "call when either is missing or unapproved. Returned conversation content is "
