...
| I-178 | A refusal decided inside a returning tenure survives its own rollback | `registry._record_raced`, applied to that call as well as to the insert path, so a refused handback still leaves the contest it lost | implemented |
