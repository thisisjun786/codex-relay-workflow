...
# that entry's sequence, so each naming is one occurrence and a name the hold returns to is recorded
# again, while a reading that keeps the name adds nothing (independent review of 72178ee8).
