"""Record the Python relay CLI's answers for the linkage commands (cli_cases.json).

  uv run --no-sync python internal/relay/registry/testdata/gen_cli.py \
      > internal/relay/linkage/testdata/python_cli.json
...
cases = json.load(open("internal/relay/linkage/testdata/cli_cases.json"))
out = {}
