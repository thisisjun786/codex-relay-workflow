"""Record the Python relay CLI's answers for the capacity commands (todo 27 part A) (cli_cases.json).

  uv run --no-sync python internal/relay/capacity/testdata/gen_cli.py \
      > internal/relay/capacity/testdata/python_cli.json
...
cases = json.load(open("internal/relay/capacity/testdata/cli_cases.json"))
out = {}
