"""Record the Python relay CLI's answers for the edit-region commands (todo 27 part A) (region_cli_cases.json).

  uv run --no-sync python internal/relay/capacity/testdata/gen_region_cli.py \
      > internal/relay/capacity/testdata/python_region_cli.json
...
cases = json.load(open("internal/relay/capacity/testdata/region_cli_cases.json"))
out = {}
