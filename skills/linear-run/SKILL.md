...
Read [Integrations](../linear-plan/references/integrations.md) for Linear document
...
[linear-plan](../linear-plan/SKILL.md) within the user's requested scope.
...
[Default independent execution](../linear-plan/references/integrations.md#default-independent-execution).
...
does not override the host's explicit-creation requirement. Apply the shared [delivery and integration default](../linear-plan/references/integrations.md#default-dev-integration)
...
use [linear-focus](../linear-focus/SKILL.md) for its recorded project link,
...
[linear-check](../linear-check/SKILL.md) as a bounded audit and retain coordination
here. Use [linear-logic](../linear-logic/SKILL.md) for a specific suspected logical
...
After verification, the coordinator applies [Default dev integration](../linear-plan/references/integrations.md#default-dev-integration),
...
Apply the completion-follow-up rule in [Integrations](../linear-plan/references/integrations.md#completion-follow-up-in-an-existing-execution-workflow).
