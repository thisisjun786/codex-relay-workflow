...
Ordinary `linear-run` does not need any of this. Without a managed marker a session is an
...
wiring `linear-run` to write markers are later issues. The measured comparison is a later issue too,
