...
the assignment and host permissions as described in [Integrations](../../linear-plan/references/integrations.md#completion-follow-up-in-an-existing-execution-workflow).
