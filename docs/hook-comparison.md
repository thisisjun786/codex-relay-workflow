...
[preparing and starting a live trial](live-trial.md). That procedure prepares a run on a host; it
measures nothing itself, and nothing in it changes what this harness reports.
