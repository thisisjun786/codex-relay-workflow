...
| `scripts/ci/tests/test_gate.py` | 15 | C | dev-gate check selection and result judgement | `.github/workflows/ci.yml` | todo 47 / CRW-160 | go-test: `crw-dev ci gate` (todo 47; `internal/dev/ci` Test47_GATE_1..9) | importlib spec_from_file_location of scripts/ci/gate.py |
