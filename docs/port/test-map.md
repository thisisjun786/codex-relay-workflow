...
| `packages/codex-session-relay/tests/test_diagnostics.py` | 32 | B | diagnosis words that tell an operator what to do | - | todo 20 / CRW-152 | go-test: doctor/diagnostics package (todo 20) + go-test: `internal/relay/store` (todo 19: typed queries, guard-index refusals and Python-store parity for the tables this file writes) | - |
