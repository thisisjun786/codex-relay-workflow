...
- This repository holds the skill instructions under `skills/` and two imported Python packages under `packages/`. Read the target skill and its linked references before editing. Keep skill names, folder names, UI prompts, and relative links consistent.
