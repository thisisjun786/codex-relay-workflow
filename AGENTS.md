...
- Maintain the `skills/linear-*` directories together. Shared workflow rules live in `skills/linear-plan/references/integrations.md`; operation-specific rules stay in their owning skill.
